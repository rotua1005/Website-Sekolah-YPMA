...
const KelolaNilaiAkhirKepsek = {
    async render() {
        let mapelList = [];
        // Ambil data kelas yang dipilih dari localStorage (gunakan key baru: kelasUntukNilaiAkhirKepsek)
        const kelasUntukNilaiAkhir = JSON.parse(localStorage.getItem('kelasUntukNilaiAkhirKepsek'));
    ...
    async loadDetailNilaiInfo() {
        ...
        // Ambil data kelas dari localStorage (key baru)
        const kelasUntukNilaiAkhir = JSON.parse(localStorage.getItem('kelasUntukNilaiAkhirKepsek'));
...
export default KelolaNilaiAkhirKepsek;