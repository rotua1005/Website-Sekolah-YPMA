...
class App {
    ...
    async renderPage() {
        ...
        const allowedPages = ['/', '/beranda', '/tentang', '/berita', '/ekstrakurikuler', '/feedbackpage','/detail_berita/:id','/visimisi','/fasilitas','/profilguru','/detail_ekstrakurikuler/:id','/prestasi'
            ,'/detail_prestasi/:id','/galery',
        ];
