// Front-End/src/pages/Admin/Dashboard_Berita.js
            ...
            document.querySelectorAll(".edit-btn").forEach(btn => {
                btn.addEventListener("click", async () => {
                    ...
                    try {
                        ...
                        // Store the full berita object, which contains the _id
                        localStorage.setItem('editBerita', JSON.stringify(berita));
                        // No need for 'editIndex' separately
            ...
            document.querySelectorAll(".hapus-btn").forEach(btn => {
                btn.addEventListener("click", async () => {
                    ...
                    try {
                        ...
                        await ambilBeritaDariServer(); // Re-fetch and display after deletion
                    } catch (err) {
                        console.error(err);
