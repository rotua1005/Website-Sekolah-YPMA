const VisiMisi = {
    async render() {
      // Inject Animate.css jika belum ada
      ...
      return `
          ...
          <main class="w-full mt-8">
            <section
              class="bg-gray-900 text-white py-14 md:py-16 mt-8 md:mt-12 w-full rounded-lg shadow-md animate__animated animate__fadeInRight"
            >
