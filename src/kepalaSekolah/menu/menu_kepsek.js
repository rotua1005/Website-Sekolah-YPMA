...
const MenuKepsek = {
        ...
        return `
            <div class="dashboard-sidebar bg-indigo-700 text-white p-6 shadow-lg w-64 min-h-screen flex flex-col overflow-y-auto">
                <div class="mb-5 flex items-center justify-center border-b border-indigo-600 pb-3">
                    <h1 class="text-xl font-bold hidden md:block">Kepala Sekolah</h1>
                </div>
                <nav class="flex-grow">
                    <a href="#/dashboard_kepsek" class="dashboard-link block py-2.5 px-4 rounded hover:bg-indigo-600 transition duration-200 ease-in-out">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="dashboard-menu mt-1">
                            ...
                            <div id="biodataMenu" class="dashboard-submenu mt-1 space-y-1 hidden">
                                <a href="#/data_guru_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Data Guru</a>
                                <a href="#/data_siswa_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Data Siswa</a>
                                <a href="#/data_walikelas_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Data Wali Kelas</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="dashboard-menu mt-1">
                            ...
                            <div id="akademikMenu" class="dashboard-submenu mt-1 space-y-1 hidden">
                                <a href="#/tahun_akademik_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Tahun Akademik</a>
                                <a href="#/data_kelas_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Data Kelas</a>
                                <a href="#/data_mapel_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Mata Pelajaran</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="dashboard-menu mt-1">
                            ...
                            <div id="absensiMenu" class="dashboard-submenu mt-1 space-y-1 hidden">
                                <a href="#/absensi1_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Input Absensi</a>
                                <a href="#/rekap_absensi_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Rekap Absensi</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="dashboard-menu mt-1">
                            ...
                            <div id="raportMenu" class="dashboard-submenu mt-1 space-y-1 hidden">
                                <a href="#/nilai_akhir_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Nilai Akhir</a>
                                <a href="#/rekap_nilai_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Rekap Nilai</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="dashboard-menu mt-1">
                            ...
                            <div id="informasiMenu" class="dashboard-submenu mt-1 space-y-1 hidden">
                                <a href="#/dashboard_berita_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Berita</a>
                                <a href="#/dashboard_kurikuler_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Ekstrakurikuler</a>
                                <a href="#/dashboard_prestasi_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Prestasi</a>
                                <a href="#/dashboard_profile_kepsek" class="dashboard-submenu-link block py-1.5 px-6 rounded hover:bg-indigo-500 transition duration-200 ease-in-out text-sm">Profile Sekolah</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="#/dashboard_akun_kepsek" class="dashboard-link block py-2.5 px-4 rounded hover:bg-indigo-600 transition duration-200 ease-in-out">
    ...
    afterRender() {
        ...
        } else if (window.location.hash === "#/dashboard_kepsek") {
            const dashboardLink = document.querySelector('a[href="#/dashboard_kepsek"]');
            if (dashboardLink) {
